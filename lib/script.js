let phrases = [
  ...
  { text: 'Сделать, что давно планировал', image: 'https://code.s3.yandex.net/web-code/procrastinate/10.png' },
  { text: 'Готовиться к зачету', image: 'https://code.s3.yandex.net/web-code/procrastinate/10.png' },
